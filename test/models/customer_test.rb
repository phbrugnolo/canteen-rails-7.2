...
class CustomerTest < ActiveSupport::TestCase
  test "should create a valid customer" do
    customer = Customer.new(name: "John Doe", matriculation: "123456")

    assert customer.valid?
  end

  test "should not create customer without a name" do
    customer = Customer.new(matriculation: "123456")
  ...
  test "should not create customer with duplicate matriculation" do
    Customer.create!(name: "Jane Doe", matriculation: "123456")
    duplicate_customer = Customer.new(name: "John Smith", matriculation: "123456")
